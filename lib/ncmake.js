...
const commands = {
  ...
  distclean: function (argv, cmake) {
    return new Promise(function (resolve, reject) {
      const distclean = spawn(cmake, ['-E', 'remove_directory', argv.output], {
        stdio: 'inherit'
      });
  ...
  configure: function (argv, cmake) {
    ...
    if (process.platform === 'win32' && msvcRegex.test(argv.generator) && msvcArch[argv.arch]) {
      args.push('-A');
    ...
    return new Promise(function (resolve, reject) {
      ...
      const mkdir = spawn(cmake, ['-E', 'make_directory', argv.output], {
        stdio: 'inherit'
      });
      function handleError(code) {
        if(code !== 0) {
